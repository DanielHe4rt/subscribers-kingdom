...
namespace Kingdom\Core\Classes;
...
class DomainManager {
     ...
     *
     * @param string|object $namespace Eg: Kingdom\Auth
     * @param string $path Eg: 'Kingdom/Auth';
    ...
    public function loadDomain($namespace, string $path)
    {
        ...
        if(!is_subclass_of($class, DomainInterface::class)){
            throw new DomainExtendException('The domain must extend the abstract class \Kingdom\Core\Contracts\DomainInterface');
        }
